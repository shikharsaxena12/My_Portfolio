...
const Skills = () => {
  ...
  const labels = {
    mySkills: skillsContent.title || 'My Skills',
    whatIDo: 'What I Do'
  };
  ...
  return (
    <div className={`h-screen overflow-hidden transition-all duration-1000 ${isDark ? 'bg-gradient-to-br from-blue-600 via-purple-600 to-pink-600' : 'bg-gradient-to-br from-amber-100 via-orange-200 to-rose-300'}`}>
      ...
      <div className="relative z-10 container mx-auto px-6 pt-32 pb-20">
        {techSkills.length === 0 && softSkills.length === 0 && !skillsContent.title && !skillsContent.subtitle && !skillsContent.description1 && !skillsContent.description2 && (!skillsContent.whatIDo || skillsContent.whatIDo.length === 0) ? (
          <div className={`text-center py-32 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
            <h1 className={`text-6xl font-bold mb-6 ${isDark ? 'text-white' : 'text-black'}`}>
              Skills Page is Coming Soon
            </h1>
            <p className="text-2xl">
              We're working hard to bring you an amazing skills showcase!
            </p>
          </div>
        ) : (
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className={`font-inter p-8 rounded-3xl backdrop-blur-xl border relative overflow-hidden transition-all duration-700 ${isDark ? 'bg-gradient-to-br from-blue-600/20 via-purple-600/20 to-pink-600/20 border-white/20' : 'bg-gradient-to-br from-amber-100/40 via-orange-100/40 to-rose-100/40 border-amber-200/60'}`}>
              ...
              {techSkills.length === 0 && softSkills.length === 0 ? (
                <div className={`text-center py-16 relative z-10 ${isDark ? 'text-gray-400' : 'text-gray-600'}`}>
                  <h3 className={`text-2xl font-bold mb-4 ${isDark ? 'text-white' : 'text-black'}`}>
                    Sorry, No Content Available
                  </h3>
                  <p className="text-lg">
                    Skills will appear here when loaded, as I know you want to know more about skills.
                  </p>
                </div>
              ) : (
                <>
          ...
          >
            {!skillsContent.title && !skillsContent.subtitle && !skillsContent.description1 && !skillsContent.description2 && (!skillsContent.whatIDo || skillsContent.whatIDo.length === 0) ? (
                ...
                {skillsContent.whatIDo && skillsContent.whatIDo.length > 0 && (
                  <div className="space-y-4">
                    ...
                    <ul className={`space-y-2 transition-all duration-700 ${isDark ? 'text-gray-300' : 'text-black'}`}>
                      {skillsContent.whatIDo.map((item, index) => (
