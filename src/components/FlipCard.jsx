  ...
  return (
    ...
    >
      <div className="relative w-full h-full [transform-style:preserve-3d] transition-transform duration-700 group-hover:[transform:rotateY(180deg)]">
        {/* Front Face */}
        <div className={`absolute inset-0 w-full h-full rounded-2xl backdrop-blur-sm border [backface-visibility:hidden] ${
          isDark 
        ...
        {/* Back Face */}
        <div className={`absolute inset-0 w-full h-full rounded-2xl backdrop-blur-sm border [backface-visibility:hidden] [transform:rotateY(180deg)] ${
          isDark 
